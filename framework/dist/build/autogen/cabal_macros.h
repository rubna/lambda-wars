...
/* package lambda-wars-0.1.0.0 */
#define VERSION_lambda_wars "0.1.0.0"
#define MIN_VERSION_lambda_wars(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "lambda-wars-0.1.0.0"

#define CURRENT_PACKAGE_KEY "lambda-wars-0.1.0.0"
